...
def reachable_before {V Graph: Type*}
...
def reachable_before_same_scc {V Graph: Type*}
                              [DirectedGraph V Graph]
                              [BEq V] [LawfulBEq V]
                              (g : Graph)
                              (s: List V) : Prop :=
...
theorem reachable_before_shrink {V Graph: Type*}
                                [DirectedGraph V Graph]
                                [BEq V] [LawfulBEq V]
                                (g : Graph) :
...
theorem reachable_before_extension {V Graph: Type*}
                                   [DirectedGraph V Graph]
                                   [BEq V] [LawfulBEq V]
                                   (g : Graph) :
...
theorem no_edge_out_of_cons {V Graph: Type*}
                            [DirectedGraph V Graph]
                            [BEq V] [LawfulBEq V]
                            (g : Graph)
                            (s1 s2: List V) (x : V) :
...
theorem path_cross_sets {V Graph: Type*}
                        [DirectedGraph V Graph]
                        [BEq V] [LawfulBEq V]
                        (g : Graph) :
   ∀ l (x y : V) s1 s2 ,
...
theorem no_edge_out_of_no_path_out_of_in {V Graph: Type*}
                                        [DirectedGraph V Graph]
                                        [BEq V] [LawfulBEq V]
                                        (g : Graph) :
    ∀ (s1 s2 : List V),
...
theorem no_black_to_white_no_path {V Graph: Type*}
                                [DirectedGraph V Graph]
                                [BEq V] [LawfulBEq V]
                                (g : Graph) :
∀ (b : List V),
...
theorem no_black_to_white_in_the_middle {V Graph: Type*}
                                        [DirectedGraph V Graph]
                                        [BEq V] [LawfulBEq V]
                                        (g : Graph) :
...
simp [paths_in_set]
intros b b' h₁ h₂ _ x l y h₄ h₅ h₆ z h₇ z hz
rw [List.mem_filter] at *
simp_all
have h₈ := List.append_of_mem hz
obtain ⟨l₁, l₂, h₈⟩:= h₈
subst l
have ⟨h₈, h₉⟩ := path_decomposition g x z y l₁ l₂ h₇
by_cases z ∈ b' <;> by_cases z ∈ b <;> constructor <;> try assumption
. intros g₃
  apply no_black_to_white_no_path g b h₁ l₂ z y g₃ (by assumption) h₉
. exfalso
...
theorem wff_stack_white_extension {V Graph: Type*}
                                  [DirectedGraph V Graph]
                                  [BEq V] [LawfulBEq V]
                                  (g : Graph) :
...
intros grey _ s s' _ _ _ _ _ _ h₅ _ g₂ _ _ _ _ g₁ x g₄
constructor <;> intros h <;> simp_all
. unfold List.Nodup at g₂
  rw [List.pairwise_append] at g₂
  obtain ⟨_, _, g₂⟩ := g₂
  apply g₂ x (by assumption) x (by assumption) rfl
. apply h₅ x
  . simp_all
  . apply g₁ h
