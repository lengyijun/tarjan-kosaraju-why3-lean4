...
(* Why3 goal *)
Theorem simplelist_split_1 {a:Type} {a_WT:WhyType a} :
...
Proof.
intros x.
induction l1; induction l3; intros; simpl in *; auto.

exfalso; apply H2; inversion H; auto.
exfalso; apply H0; inversion H; auto.
